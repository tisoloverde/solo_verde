<?php
	...
	if(count($_POST) > 0){
        ...
        move_uploaded_file($_FILES['pdfChecklist']['tmp_name'],'repositorio/flota/desasignaciones/checklistFirmada_' .$doc);
        $contadorChecklist = 2;

        $row = desasignarVehiculo($idDesasig, $docPDFChecklist, $contadorChecklist, $patente, $rutPersonal);
        $delPatentePersonal = eliminarPatentePersonal($rutPersonal, $patente);
        ...
        $estadoControl = $v1[0]['ESTADO_CONTROL'];
    		...
    		$rutAsig = $v1[0]['DNI'];
        $mensaje = "Desasignación finalizada correctamente";
        $frealizada = "";
    		$fcaducidad = "";
    		$frealizadaCir = "";
    		$fcaducidadCir = "";
		...
		if($row != "Error"){
            ...
            ingresarNotificacionAsignacionVeh($rutJefe, 'Desasignación', "Le informamos que la siguiente patente " . $patente . " asignada a " . $personal . " ha sido desasignada corectamente",
            "#/notificaciones", "Patente Desasignada<br>" .  $patente, "Patente Desasignada");
            ...
            $body = "<p><em><span style='color:rgb(165, 165, 165)'><u>Solo Verde - Favor no responder este e-mail</u></span></em></p><br>
                    ...
                    <br />
                    <br />
                    Le informamos que la siguiente patente " . $patente . " asignada a " . $personal . " ha sido desasignada corectamente<br /><br />
                    <br />
                    </font>
                    <div'>
                        <font style='font-size: 14px;'>
            ...
            $mail->Subject = "Desasignación de Vehículo " . $fecha . "";

                //Puedo definir un cuerpo alternativo del mensaje, que contenga solo texto
            $mail->AltBody = "Desasignación de Vehículo " . $fecha . "";
