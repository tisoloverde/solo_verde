<?php
  ...
  function init($mail) {
    ...
    $mail->Subject = "Solicitud de Jefatura " . getFecha() . "";
    $mail->AltBody = "Solicitud de Jefatura " . getFecha() . "";
    ...
    $body = "<p><em><span style='color:rgb(165, 165, 165)'><u>Solo Verde - Favor no responder este e-mail</u></span></em></p><br>
      <div style='width: 100%; text-align: justify; margin: 0 auto;'>
        <font style='font-size: 14px;'>
          ...
          <br />
          <br />
          Le informamos que se ha solicitado nuevo personal: <br />" .
          $lstNamesPersonal . "
          <br />
          <br />
    ...
    $body = "
      <div style='width: 100%; text-align: justify; margin: 0 auto;'>
        <font style='font-size: 14px;'>
          ...
          <br />
          <br />
          Le informamos que la jefatura del siguiente personal ha sido solicitado por " . $nombreNuevoJefe . ": <br />" .
          $lstNamesPersonal . "
          <br />
          <br />
        </font>
