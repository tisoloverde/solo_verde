<?php
  ...
  function init($mail) {
    ...
    $mail->Subject = "Rechazado - Solicitud de Jefatura " . getFecha() . "";
    $mail->AltBody = "Rechazado - Solicitud de Jefatura " . getFecha() . "";
    ...
    $body = "
      <div style='width: 100%; text-align: justify; margin: 0 auto;'>
        <font style='font-size: 14px;'>
          ...
          <br />
          <br />
          Le informamos que se ha rechazado el personal solicitado: <br /><br />" .
          $lstNamesPersonal . "
          <br />
          <br />
        </font>
    ...
    $body = "<p><em><span style='color:rgb(165, 165, 165)'><u>Bases de inmuebles - Favor no responder este e-mail</u></span></em></p><br>
      <div style='width: 100%; text-align: justify; margin: 0 auto;'>
        <font style='font-size: 14px;'>
          ...
          <br />
          <br />
          Le informamos que el siguiente personal ha sido rechazado para ser solicitado a la jefatura de " . $nombreNuevoJefe . ": <br />" .
          $lstNamesPersonal . "
          <br />
          <br />
        </font>
