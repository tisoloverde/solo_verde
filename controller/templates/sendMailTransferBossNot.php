<?php
  ...
  function init($mail) {
    ...
    $mail->Subject = "Rechazado - Transferencia de Jefatura " . getFecha() . "";
    $mail->AltBody = "Rechazado - Transferencia de Jefatura " . getFecha() . "";
    ...
    $body = "<p><em><span style='color:rgb(165, 165, 165)'><u>Sistema integración Equans - Favor no responder este e-mail</u></span></em></p><br>
      <div style='width: 100%; text-align: justify; margin: 0 auto;'>
        <font style='font-size: 14px;'>
          ...
          <br />
          <br />
          Le informamos que se ha rechazado el personal transferido: <br />" .
          $lstNamesPersonal . "
          <br />
          <br />
        </font>
    ...
    $body = "
      <div style='width: 100%; text-align: justify; margin: 0 auto;'>
        <font style='font-size: 14px;'>
          ...
          <br />
          <br />
          Le informamos que el siguiente personal ha sido rechazado para ser transferido a la jefatura de " . $nombreNuevoJefe . ": <br />" .
          $lstNamesPersonal . "
          <br />
          <br />
        </font>
