<?php
  ...
  if ($ceco ==-1){
    ...
    $nombreDoc =  'Informe_Validacion_Mensual_' . $anoMes ."_". $ceco . "_" . $rut . '_' . $hora . ".xlsx";
    $nombreDoc2 = 'Informe_Validacion_Mensual_UTF8_' . $anoMes ."_". $ceco . "_" . $rut . '_' . $hora . ".xlsx";
  }

  $delimiter = ";";

  $logFile = fopen($ruta . "/controller/repositorio/temp/Informe_Validacion_Mensual_" . $anoMes ."_". $ceco . "_" . $rut . '_' . $hora . "_log.txt", 'a') or die("Error creando archivo");
