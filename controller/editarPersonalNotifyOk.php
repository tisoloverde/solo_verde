<?php
  ...
  require('templates/sendMailTransferBossOk.php');
  ...
  if (count($_POST) > 0) {
    ...
    if ($row != "error" ) {
      ...
      $row = ingresaUsuarioNotificacionPorMail($emailNuevoJefe, 'Personal', "Le informamos que se le ha aprobado la transferencia de nuevo personal: <br />" . $strlstPersonal['nombres'], "Personal fue aprobado para ser transferido a su jefatura<br>" . $strlstPersonal['nombres'], "Personal transferido aprobado", "#/notificaciones");
