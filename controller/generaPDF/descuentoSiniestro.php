...
$document = $ruta . 'repositorio/flota/siniestros/descuento';
$random = md5(rand());
...
$danosTercero = $datos[0]['PATENTE_TERCERO'];
				...
				<tr>
					...
					<td style="max-width: 358px; min-width: 358px; width: 358px; ">
						<table style="margin-top: 30px;">
							<TR>
								<td style="padding-left: 0px; font-size: 22px; font-weight: bold; max-width: 358px; min-width: 358px; width: 358px; text-align: center; ">Descuento Siniestro</td>
							</TR>
						</table>
					</td>
...
<table style="margin-left: 40px; width: 90%; max-width: 90%; min-width: 90%; height: 400px; max-height: 400px; min-height: 400px; margin-top: 20px;">
    <tr>
        <td style="width: 80%; max-width: 80%; min-width: 80%; text-align: justify; font-size: 14px; margin-bottom: 10px;">
            ...
            <b style="font-weight: normal;">Declaro estar de acuerdo con el descuento aplicado por el siniestro con folio </b><span style="font-weight: bold;"><?php echo $datos[0]['FOLIO'];?></span><b>,</b>
            <b style="font-weight: normal;">ocurrido al vehículo con patente </b><span style="font-weight: bold;"><?php echo $datos[0]['CODIGO'];?></span><b style="font-weight: normal;"> del proyecto </b><span style="font-weight: bold;"><?php echo $datos[0]['PROYECTO'];?></span>
            <b style="font-weight: normal;"> en la comuna </b> <span style="font-weight: bold;"><?php echo $datos[0]['COMUNA'];?></span><b>.</b><br/><br/>
            <b style="font-weight: normal;">El descuento aplicado corresponde al monto de $</b><span style="font-weight: bold;"><?php echo $_POST['montoDesc'];?></span>
            <b style="font-weight: normal;">el que sera asumido por el </b>
            <span style="font-weight: bold;"><?php
            if ($_POST['descuento'] === 'Descuento'){
                echo "colaborador";
            }
            else{
                echo "proyecto";
            ...
            ?></span>
            <b style="font-weight: normal;">y corresponde al deducible por los daños informados en el siniestro con folio </b><span style="font-weight: bold;"><?php echo $datos[0]['FOLIO'];?></span><b>.</b><br/><br/><br>
        </td>
    </tr>
	<tr>
		<td style="width: 100%; max-width: 100%; min-width: 100%;">
			...
			<br/>
			<br/>
			<table style="font-size: 15px; width: 100%; max-width: 100%; min-width: 100%;">
				<tr>
...
$html2pdf->output($document . '/descuento_' . $random . '.pdf', 'F');
$pdfDescuento = 'descuento_' . $random . '.pdf';
actualizarSiniestroDescuento($idSiniestro, $pdfDescuento);
echo '/descuento_' . $random . '.pdf';
?>