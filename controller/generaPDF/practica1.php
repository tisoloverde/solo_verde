...
$id = $_POST['id'];
// $id = 402;
// $_POST['url'] = 'http://127.0.0.1/git/web_operaciones/';
...
$datosPerForm = datosPersonalFormulario($id);
			...
			<table style="font-size: 10px; width: 100%; max-width: 100%; min-width: 100%;">
              ...
              <tr>
							...
							<tr>
								...
								<td style="width: 58%; max-width: 58%; min-width: 58%; text-align: left;">
									<?php
										for($i = 0; $i < count($datosPerForm); $i++){
											echo $datosPerForm[$i]['TECNICOS'];
											echo "<br>";
										}
									?>
								</td>
...
<table style="margin-top: -1px; margin-left: 40px; width: 90%; max-width: 90%; min-width: 90%; height: 400px; max-height: 400px; min-height: 400px; border-spacing: 0 0; border-collapse : collapse;">
  ...
  <?php
    ...
    for($j = 0; $j < count($categoria); $j++){
      ...
      echo '<table style="margin-top: 5px; width: 100%; max-width: 100%; min-width: 100%;"><tr><td style="width: 100%; max-width: 100%; min-width: 100%; "><table style="font-size: 10px; width: 100%; max-width: 100%; min-width: 100%;"><tr><td style="width: 100%; max-width: 100%; min-width: 100%; text-align: center;"><table style="vertical-align: top; width: 100%; max-width: 100%; min-width: 100%;"><tr><td style="; width: 47%; max-width: 47%; min-width: 47%; text-align: left; font-size: 13px;"><b>' . $categoria[$j]['TEXTOCATEGORIA'] . ':</b></td><td rowspan="20" style="border-left: 1px solid #eeeeee; padding-left: 5px; padding-right: 5px; width: 47%; max-width: 47%; min-width: 47%; text-align: justify;"><b>Observación:<br><br></b> ' . $categoria[$j]['OBSERVACIONES'] . '</td>';
...
<page>
	...
	echo '<table style="margin-left: 40px; width: 90%; max-width: 90%; min-width: 90%; height: 400px; max-height: 400px; min-height: 400px; border-spacing: 0 0; border-collapse : collapse; margin-top: 15px;"">';
	echo '<tr><td style="width: 100%; max-width: 100%; min-width: 100%; border: 1px solid black;">';
  	echo '<table style="background-color: #e8e8e8; width: 100%; max-width: 100%; min-width: 100%;"><tr><td style=" width: 100%; max-width: 100%; min-width: 100%; text-align: left;"><b style="font-size: 14px;">ANEXO IMÁGENES</b>';
	echo '</td></tr></table>';
	echo '</td></tr>';
	echo '</table>';

	echo '<table style="margin-left: 40px; width: 90%; max-width: 90%; min-width: 90%; height: 400px; max-height: 400px; min-height: 400px; border-spacing: 0 0; border-collapse : collapse; margin-top: 15px;"">';
	  for($o = 0; $o < count($row2); $o++){
		$categoria = $row2[$o]['CATEGORIA'];
		$countFoto = 0;
		echo '<tr>';
		for($l = 0; $l < count($categoria); $l++){
			if($chequeaFoto[$categoria[$l]['CATEGORIA'] . $categoria[$l]['TIPOAUDITORIAid'] . $categoria[$l]['idFORMULARIO'] . $categoria[$l]['TEXTOFAMILIA'] . '_1.png'] != 'Sin datos'){
				echo '<td style=" width: 50%; max-width: 50%; min-width: 50%; text-align: left;">';
				list($ancho , $alto) = getimagesize($chequeaFoto[$categoria[$l]['CATEGORIA'] . $categoria[$l]['TIPOAUDITORIAid'] . $categoria[$l]['idFORMULARIO'] . $categoria[$l]['TEXTOFAMILIA'] . '_1.png']);
				if($ancho >= $alto){
					echo $categoria[$l]['TEXTOFAMILIA'] . ' - ' . $categoria[$l]['TEXTOCATEGORIA'] . ' - 1';
					echo '<br>';
					echo '<img style="margin-top: 5px; margin-left: 0px; width: 300px; min-width: 300px; max-width: 300px;"';
					echo "src='" . $chequeaFoto[$categoria[$l]['CATEGORIA'] . $categoria[$l]['TIPOAUDITORIAid'] . $categoria[$l]['idFORMULARIO'] . $categoria[$l]['TEXTOFAMILIA'] . '_1.png'] . "'";
					echo '>';
					$countFoto++;
				}
				else{
					echo $categoria[$l]['TEXTOFAMILIA'] . ' - ' . $categoria[$l]['TEXTOCATEGORIA'] . ' - 1';
					echo '<br>';
					echo '<img style="margin-top: 5px; margin-left: 0px; height: 300px; min-height: 300px; max-height: 300px;"';
					echo "src='" . $chequeaFoto[$categoria[$l]['CATEGORIA'] . $categoria[$l]['TIPOAUDITORIAid'] . $categoria[$l]['idFORMULARIO'] . $categoria[$l]['TEXTOFAMILIA'] . '_1.png'] . "'";
					echo '>';
					$countFoto++;
				}
			...
			// if($chequeaFoto[$categoria[$l]['CATEGORIA'] . $categoria[$l]['TIPOAUDITORIAid'] . $categoria[$l]['idFORMULARIO'] . $categoria[$l]['TEXTOFAMILIA'] . '_1.png'] != 'Sin datos' && $chequeaFoto[$categoria[$l]['CATEGORIA'] . $categoria[$l]['TIPOAUDITORIAid'] . $categoria[$l]['idFORMULARIO'] . $categoria[$l]['TEXTOFAMILIA'] . '_2.png']  != 'Sin datos'){
			// 	echo "<br><br>";
			// }
			if($chequeaFoto[$categoria[$l]['CATEGORIA'] . $categoria[$l]['TIPOAUDITORIAid'] . $categoria[$l]['idFORMULARIO'] . $categoria[$l]['TEXTOFAMILIA'] . '_2.png'] != 'Sin datos'){
				echo '<td style=" width: 50%; max-width: 50%; min-width: 50%; text-align: left;">';
				list($ancho , $alto) = getimagesize($chequeaFoto[$categoria[$l]['CATEGORIA'] . $categoria[$l]['TIPOAUDITORIAid'] . $categoria[$l]['idFORMULARIO'] . $categoria[$l]['TEXTOFAMILIA'] . '_2.png']);
				if($ancho >= $alto){
					echo $categoria[$l]['TEXTOFAMILIA'] . ' - ' . $categoria[$l]['TEXTOCATEGORIA'] . ' - 2';
					echo '<br>';
					echo '<img style="margin-top: 5px; margin-left: 0px; width: 300px; min-width: 300px; max-width: 300px;"';
					echo "src='" . $chequeaFoto[$categoria[$l]['CATEGORIA'] . $categoria[$l]['TIPOAUDITORIAid'] . $categoria[$l]['idFORMULARIO'] . $categoria[$l]['TEXTOFAMILIA'] . '_2.png'] . "'";
					echo '>';
					$countFoto++;
				}
				else{
