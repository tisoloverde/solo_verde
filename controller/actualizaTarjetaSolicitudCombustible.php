<?php
	...
	if(count($_POST) > 0){
        ...
        $row = actualizaTarjetaSolicitudCombustible( $idSolicitud, $montoValidado, $observacionValidacion, $rutUser);
        ...
        $rutAsig = $v1[0]['DNI'];
        $mensaje = "Se validó solicitud ".$cargaTipo." carga combustible";
        $frealizada = "";
        $fcaducidad = "";
        $frealizadaCir = "";
        $fcaducidadCir = "";
