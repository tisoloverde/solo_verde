<?php
    ...
    if(count($_POST) > 0){
        ...
        $row = editarProyectoControlling($idProyecto, $definicion,	$pep,	$crm,	$proyecto,	$denominacion,	$sociedad,	$gerencia,	$controller,	$adminContrato,	$cliente,	$fechaIniContrato,	$fechaFinContrato,	$fechaIniProyecto,	$fechaFinProyecto,	$estado, $rutUser);
