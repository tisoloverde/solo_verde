<?php
  ...
  require('templates/sendMailSolicitBossNot.php');
  ...
  if (count($_POST) > 0) {
    ...
    if ($row != "error" ) {
      ...
      $row = ingresaUsuarioNotificacionPorMail($emailNuevoJefe, 'Personal', "Le informamos que se le ha rechazado la solicitud de nuevo personal: <br />" . $strlstPersonal['nombres'], "Personal fue rechazado para ser solicitado a su jefatura<br>" . $strlstPersonal['nombres'], "Personal solicitado rechazado", "#/notificaciones");
