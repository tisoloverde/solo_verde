<?php
    ...
    if(count($_POST) > 0){
        ...
        $row = actualizarEstadoValidadoAsigVeh($idAsig);
        ...
        if($row != "Error" )
        {
            ...
            ingresarNotificacionAsignacionVeh($rutJefe, 'Asignación', "Le informamos que la siguiente patente " . $patente . " asignada a " . $personalAsig . " ha sido Validada correctamente", "#/notificaciones", "Asignación Validada<br>" .  $patente, "Asignación Validada");
            ...
            $body = "<p><em><span style='color:rgb(165, 165, 165)'><u>Bases de inmuebles - Favor no responder este e-mail</u></span></em></p><br>
                    ...
                    <br />
                    <br />
                    Le informamos que la siguiente patente " . $patente . " asignada al personal " . $personalAsig . " ha sido validada correctamente.<br /><br />
                    <br />
                    </font>
                    <div'>
                        <font style='font-size: 14px;'>
            ...
            $mail->Subject = "Asignación de Vehículo Validada " . $fecha . "";

                //Puedo definir un cuerpo alternativo del mensaje, que contenga solo texto
            $mail->AltBody = "Asignación de Vehículo Validada " . $fecha . "";
