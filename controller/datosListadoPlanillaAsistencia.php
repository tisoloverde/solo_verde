    ...
    if (is_array($lstPersonalCC)) {
      for ($i=0; $i<count($lstPersonalCC); $i++) {
        ...
        $row = [
          ...
          "FECHA_REEMPLAZO" => "",
          // "NDIAS" => $ndias,
          "HE50" => "<input id='planilla-input-col22-$idPersonal' class='planilla-input onlyNumbersNaturals' style='border: none; text-align: center;' value='" . $found['HE50'] . "'>",
          "HE100" => "<input id='planilla-input-col23-$idPersonal' class='planilla-input onlyNumbersNaturals' style='border: none; text-align: center;' value='" . $found['HE100'] . "'>",
