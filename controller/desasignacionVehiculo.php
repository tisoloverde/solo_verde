<?php
    ...
    if(count($_POST) > 0){
        ...
        $row = desasignacionVehiculo($patente, $observacion, $kilometraje, $rutPersonal);
        $actAsignacion = actualizaEstadoPatenteAsignacionParaDesasignar($rutPersonal);
        // $delPatentePersonal = eliminarPatentePersonal($rutPersonal);
        ...
        $estadoControl = $v1[0]['ESTADO_CONTROL'];
    		...
    		$rutAsig = $v1[0]['DNI'];
        $mensaje = "Se genero una nueva desasignación";
        $frealizada = "";
    		$fcaducidad = "";
    		$frealizadaCir = "";
    		$fcaducidadCir = "";
        ...
        if($row != "Error" )
        {
          ...
          ingresarNotificacionAsignacionVeh($rutJefe, 'Desasignación', "Le informamos que la siguiente patente " . $patente . " asignada a " . $personalAsig . " se encuentra en proceso de Desasignación",
	      ...
	      $body = "<p><em><span style='color:rgb(165, 165, 165)'><u>Sistema integración Equans - Favor no responder este e-mail</u></span></em></p><br>
			    ...
			    <br />
			    <br />
			    Le informamos que la siguiente patente " . $patente . " asignada a " . $personalAsig . " se encuentra en proceso de Desasignación<br /><br />
	            <br />
			    </font>
			    <div'>
			        <font style='font-size: 14px;'>
