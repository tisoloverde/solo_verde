...
app.config(function($routeProvider, $locationProvider) {
    ...
    .when("/login", {
        ...
        controllerAs: "vm",
        templateUrl : "view/home/login.html?idLoad=80"
    })
    .when("/home", {
        controller: "homeController",
        controllerAs: "vm",
        templateUrl : "view/home/home.html?idLoad=80"
    })
    .when("/logout", {
    ...
    .when("/changePass", {
        ...
        controllerAs: "vm",
        templateUrl : "view/home/changePass.html?idLoad=80"
    })
    .when("/usuarios", {
        controller: "usuariosController",
        controllerAs: "vm",
        templateUrl : "view/usuario/usuarios.html?idLoad=80"
    })
    .when("/perfiles", {
        controller: "perfilesController",
        controllerAs: "vm",
        templateUrl : "view/usuario/perfiles.html?idLoad=80"
    })
    .when("/dotacion", {
        controller: "dotacionController",
        controllerAs: "vm",
        templateUrl : "view/personal/dotacion.html?idLoad=80"
    })
    .when("/subcontratistas", {
        controller: "subcontratistasController",
        controllerAs: "vm",
        templateUrl : "view/controlling/subcontratistas.html?idLoad=80"
    })
    .when("/gerencia", {
        controller: "gerenciaController",
        controllerAs: "vm",
        templateUrl : "view/controlling/gerencia.html?idLoad=80"
    })
    .when("/estadoProyecto", {
        controller: "estadoProyectoController",
        controllerAs: "vm",
        templateUrl : "view/controlling/estadoProyecto.html?idLoad=80"
    })
    .when("/clienteProyecto", {
        controller: "clienteController",
        controllerAs: "vm",
        templateUrl : "view/controlling/cliente.html?idLoad=80"
    })
    .when("/centro_costos",{
        controller: "proyectosController",
        controllerAs: "wm",
        templateUrl: "view/controlling/proyecto.html?idLoad=80"
    })
    .when("/gestionJefatura", {
      controller: "jefaturaController",
      controllerAs: "vm",
      templateUrl : "view/adminPersonal/gestionJefatura.html?idLoad=80"
    })
    .when("/areaFuncional", {
        controller: "mantenedorAreaFuncionalController",
        controllerAs: "vm",
        templateUrl : "view/adminPersonal/areaFuncional.html?idLoad=80"
    })
    // Sucursales
    .when("/sucursales", {
      controller: "sucursalController",
      controllerAs: "vm",
      templateUrl : "view/adminPersonal/sucursal.html?idLoad=80"
    })
    .when("/paises", {
        controller: "mantenedorPaisesController",
        controllerAs: "vm",
        templateUrl : "view/adminPersonal/paises.html?idLoad=80"
    })
    .when("/equipo", {
        controller: "personalController",
        controllerAs: "vm",
        templateUrl : "view/personal/personal.html?idLoad=80"
    })
    .when("/planillaAsistencia", {
      controller: "planillaAsistenciaController",
      controllerAs: "vm",
      templateUrl : "view/personal/planillaAsistencia.html?idLoad=80"
    })
    .when("/indicadorAusentismo", {
      controller: "indicadorAusentismoController",
      controllerAs: "vm",
      templateUrl : "view/reporteria/ausentismo.html?idLoad=80"
    })
    // Inicio Flota
    .when("/tipoVehiculo", {
      controller: "tipoVehiculoController",
      controllerAs: "vm",
      templateUrl : "view/flota/tipoVehiculo.html?idLoad=80"
    })
    .when("/marcaModelo", {
      controller: "marcaModeloController",
      controllerAs: "vm",
      templateUrl : "view/flota/marcaModelo.html?idLoad=80"
    })
    .when("/aseguradoras", {
      controller: "aseguradoraController",
      controllerAs: "vm",
      templateUrl : "view/flota/aseguradora.html?idLoad=80"
    })
    .when("/flotaProveedores", {
      controller: "proveedoresController",
      controllerAs: "vm",
      templateUrl : "view/flota/proveedores.html?idLoad=80"
    })
    .when("/listadoVehiculos", {
      controller: "vehiculoController",
      controllerAs: "vm",
      templateUrl : "view/flota/vehiculo.html?idLoad=80"
    })
    .when("/tarCombustible", {
        controller: "tarjetasCombustibleController",
        controllerAs: "vm",
        templateUrl : "view/flota/tarjetasCom.html?idLoad=80"
    })
    // Fin Flota
                ...
                setTimeout(function(){
                  ...
                  setTimeout(async function(){
                    ...
                    setTimeout(function(){
                      ...
                      js.src = 'view/js/funciones.js?idLoad=80';
