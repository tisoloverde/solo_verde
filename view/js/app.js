...
app.config(function($routeProvider, $locationProvider) {
    ...
    .when("/areaFuncional", {
        ...
        controllerAs: "vm",
        templateUrl : "view/adminPersonal/areaFuncional.html?idLoad=209"
    })
    // Sucursales
    .when("/sucursales", {
      controller: "sucursalController",
      controllerAs: "vm",
      templateUrl : "view/adminPersonal/sucursal.html?idLoad=209"
    })
    .when("/paises", {
        controller: "mantenedorPaisesController",
        controllerAs: "vm",
        templateUrl : "view/adminPersonal/paises.html?idLoad=209"
    })
    .when("/equipo", {
        controller: "personalController",
        controllerAs: "vm",
        templateUrl : "view/personal/personal.html?idLoad=209"
    })
