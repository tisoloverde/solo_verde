...
$("#rangoFechasListadoInmuebles").unbind("click").change(async function(e){
  e.preventDefault();
  e.stopImmediatePropagation();
  ...
  await $('#tablaListadoInmuebles').DataTable( {
      ...
      "initComplete": function( settings, json){
        ...
        setTimeout(async function(){
          ...
          $("#cantidadBanosListadoInmuebles").html("Todos");
          $("#cantidadDormitoriosListadoInmuebles").html("Todos");
...
$("#comunaListadoInmuebles").unbind("click").change(function(){
  var table = $("#tablaListadoInmuebles").DataTable();
  var mano = $("#comunaListadoInmuebles").val();
  if(mano == "Todas"){
    mano = '';
  }
  table.rows('').deselect();
  table.columns('11').search(mano).draw();
});

$("#regionListadoInmuebles").unbind("click").change(function(){
  var table = $("#tablaListadoInmuebles").DataTable();
  var mano = $("#regionListadoInmuebles").val();
  if(mano == "Todas"){
    mano = '';
  }
  table.rows('').deselect();
  table.columns('12').search(mano).draw();
});

$("#tipoContactoListadoInmuebles").unbind("click").change(function(){
  var table = $("#tablaListadoInmuebles").DataTable();
  var mano = $("#tipoContactoListadoInmuebles").val();
  if(mano == "Todos"){
    mano = '';
  }
  table.rows('').deselect();
...
$("#dormitoriosListadoInmuebles").unbind("click").change(function(){
  if($("#dormitoriosListadoInmuebles").val() == 0){
    $("#cantidadDormitoriosListadoInmuebles").html("Todos");
  }
  else{
    $("#cantidadDormitoriosListadoInmuebles").html($("#dormitoriosListadoInmuebles").val());
  }
  var table = $("#tablaListadoInmuebles").DataTable();
  var mano = $("#dormitoriosListadoInmuebles").val();
  if(mano == "0"){
    mano = '';
  }
  table.rows('').deselect();
...
$("#banosListadoInmuebles").unbind("click").change(function(){
  if($("#banosListadoInmuebles").val() == 0){
    $("#cantidadBanosListadoInmuebles").html("Todos");
  }
  else{
    $("#cantidadBanosListadoInmuebles").html($("#banosListadoInmuebles").val());
  }
  var table = $("#tablaListadoInmuebles").DataTable();
  var mano = $("#banosListadoInmuebles").val();
  if(mano == "0"){
    mano = '';
  }
  table.rows('').deselect();
