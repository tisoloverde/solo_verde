...
$("#ingresarNuevoJefatura").unbind("click").click(async function(){
  ...
  if( !/AppMovil|Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
    ...
    $("#gj__comuna").select2(theme);
    $("#gj__nacionalidad").select2(theme);
    $("#gj__sexo").select2(theme);
    $("#gj__nivelEstudios").select2(theme);
    $("#gj__claseLicencia").select2(theme);
    $("#gj__estadoCivil").select2(theme);
    $("#gj__parentescoFamiliarEmpresa").select2(theme);
    ...
    $("#gj__banco").select2(theme);
    $("#gj__tipoCuenta").select2(theme);
    $("#gj__tipoContrato").select2(theme);
    $("#gj__cargoGenerico").select2(theme);
...
function validarFormularioPersonalPlanilla() {
  ...
  var isValidTelefonoContacto = $('#gj__fonoContactoEmergencia').val()
    ...
    : false;
  var __GJ_FORM_IS_VALID = isValidRut && isValidEmail && isValidNombres && isValidApellidos && isValidTelefono && isValidNombreContacto && isValidTelefonoContacto;
...
function validarFormularioPersonalPlanilla_() {
  ...
  var isValidTelefonoContacto = $('#gj__fonoContactoEmergencia_').val()
    ...
    : false;
  var __GJ_FORM_IS_VALID_ = isValidRut && isValidEmail && isValidNombres && isValidApellidos && isValidTelefono && isValidNombreContacto && isValidTelefonoContacto;
