	...
	function consultaListaACTHistorial($offset, $limit, $idEstructuraOperacion, $fechaIni, $fechaFin, $auxIni, $auxFin, $search, $sortCol, $sortOrd) {
		...
		if ($con != "No conectado") {
			$sql = "SELECT
				...
				R2.NOMBRE AS REFERENCIA2,
				P.FECHA_INGRESO,
				(SELECT FECHA_INICIO FROM PERSONAL_ESTADO WHERE IDPERSONAL = P.IDPERSONAL AND IDPERSONAL_ESTADO_CONCEPTO = 13 ORDER BY IDPERSONAL_ESTADO DESC LIMIT 1) AS FECHA_TERMINO,
