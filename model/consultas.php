	...
	function consultaPersonalDetalles($rut) {
		...
		if ($con != "No conectado") {
			$sql = "SELECT
				...
				SEXO as sexo,
				PUEBLO_ORIGINARIO as puebloOriginario,
				HABLA_ESPANIOL as esHispanoHablante,
				IDNIVEL_EDUCACIONAL as nivelEstudios,
				LEE as sabeLeer,
				ESCRIBE as sabeEscribir,
				POSEE_LICENCIA as tieneLicencia,
				IDTIPO_LICENCIA as claseLicencia,
				FECHA_VENCIMIENTO_LICENCIA as fechaVencimientoLicencia,
				IDESTADO_CIVIL as estadoCivil,
				CONTACTO_EMERGENCIA as nombreContactoEmergencia,
				TELEFONO_EMERGENCIA as fonoContactoEmergencia,
				TALLA_POLERA as tallaPolera,
				TALLA_GUANTES as tallaGuantes,
				TALLA_PANTALON as tallaPantalon,
				TALLA_ZAPATOS as tallaZapatos,
				TALLA_LEGIONARIO as tallaLegionario,
				TALLA_OVEROLL as tallaOverol,
				TALLA_OTROS as tallaOtros,
				FAMILIAR_EMPRESA as tieneFamiliarEmpresa,
				FAMILIAR_EMPRESA_NOMBRE as nombreFamiliarEmpresa,
				FAMILIAR_EMPRESA_CARGO as cargoFamiliarEmpresa,
				FAMILIAR_EMPRESA_PARENTESCO as parentescoFamiliarEmpresa,
				...
				CERTIFICADOS as lstCertificados,
				OTROS_DOCUMENTOS as lstCertificadosOtros,
				CLAVE_UNICA as tieneClaveUnica,
				FECHA_INGRESO as fechaIngresoEmpresa,
				IDTIPO_CONTRATO as tipoContrato,
				DURACION_INICIAL_CONTRATO as duracionContrato,
				CARGO_GENERICO_CODIGO as cargoGenerico,
				CLASIFICACION,
				REFERENCIA1 as ref1,
				REFERENCIA2 as ref2,
				PLAZA_SECTOR as plaza
			FROM PERSONAL
			WHERE DNI = '$rut'";
			if ($row = $con->query($sql)) {
				$return = array();
