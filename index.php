...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="view/css/fullcalendar5.css">
    ...
    <script src="view/js/fullcalendar5.js"></script>
    <script src="view/js/locales/es.js"></script>

    <link rel="stylesheet" href="view/css/style.css?idLoad=101">

    <script src="view/js/helpers/constants.js?idLoad=101"></script>
    <script src="view/js/helpers/config.js?idLoad=101"></script>
    <script src="view/js/helpers/validations.js?idLoad=101"></script>
    <script src="view/js/helpers/functions.js?idLoad=101"></script>

    <script src="view/js/funciones.js?idLoad=101"></script>
    <script src="view/js/app.js?idLoad=101"></script>
  ...
  <body ng-app="WPApp">
    <div id="modales" ng-include="'view/estructura/modales.php?idLoad=101'">
  	</div>
