...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="view/css/style.css?idload=65">
    <script src="view/js/funciones.js?idload=65"></script>
    <script src="view/js/app.js?idload=65"></script>
  ...
  <body ng-app="WPApp">
    <div id="modales" ng-include="'view/estructura/modales.php?idload=65'">
  	</div>
