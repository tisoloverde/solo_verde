...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="view/css/style.css?idLoad=75">
    <script src="view/js/funciones.js?idLoad=75"></script>
    <script src="view/js/app.js?idLoad=75"></script>
  ...
  <body ng-app="WPApp">
    <div id="modales" ng-include="'view/estructura/modales.php?idLoad=75'">
  	</div>
