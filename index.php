...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="view/css/style.css?idLoad=70">
    <script src="view/js/funciones.js?idLoad=70"></script>
    <script src="view/js/app.js?idLoad=70"></script>
  ...
  <body ng-app="WPApp">
    <div id="modales" ng-include="'view/estructura/modales.php?idLoad=70'">
  	</div>
