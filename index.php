...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="view/css/style.css?idLoad=91">

    <script src="view/js/helpers/constants.js?idLoad=91"></script>
    <script src="view/js/helpers/config.js?idLoad=91"></script>
    <script src="view/js/helpers/validations.js?idLoad=91"></script>
    <script src="view/js/helpers/functions.js?idLoad=91"></script>

    <script src="view/js/funciones.js?idLoad=91"></script>
    <script src="view/js/app.js?idLoad=91"></script>
  ...
  <body ng-app="WPApp">
    <div id="modales" ng-include="'view/estructura/modales.php?idLoad=91'">
  	</div>
