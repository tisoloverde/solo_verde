...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="view/css/style.css?idLoad=84">

    <script src="view/js/helpers/constants.js?idLoad=84"></script>
    <script src="view/js/helpers/config.js?idLoad=84"></script>
    <script src="view/js/helpers/validations.js?idLoad=84"></script>
    <script src="view/js/helpers/functions.js?idLoad=84"></script>

    <script src="view/js/funciones.js?idLoad=84"></script>
    <script src="view/js/app.js?idLoad=84"></script>
  ...
  <body ng-app="WPApp">
    <div id="modales" ng-include="'view/estructura/modales.php?idLoad=84'">
  	</div>
