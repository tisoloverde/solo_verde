...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="view/css/style.css?idload=66">
    <script src="view/js/funciones.js?idload=66"></script>
    <script src="view/js/app.js?idload=66"></script>
  ...
  <body ng-app="WPApp">
    <div id="modales" ng-include="'view/estructura/modales.php?idload=66'">
  	</div>
