...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="view/css/style.css?idLoad=76">
    <script src="view/js/funciones.js?idLoad=76"></script>
    <script src="view/js/app.js?idLoad=76"></script>
  ...
  <body ng-app="WPApp">
    <div id="modales" ng-include="'view/estructura/modales.php?idLoad=76'">
  	</div>
